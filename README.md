...
| 局限性 | 临时方案 | 计划解决方案 |
|:---:|---|---|
| pikpak服务不支持移动文件 | 添加动漫时同季度不能添加合集和单集，如果需要就通过更新功能更新单集。同理更新不能更新合集，可以通过删除整个动漫重新添加合集 | 爬虫获取播放链接；升级设备，本机做服务器，10T 空间完全替代 pikpak 服务 |
| pikpak 服务调用 api 频率不能过高 |  | 定时器 + 异步锁机制 |
| pikpak 服务不允许多次并发调用 api（含不同的 api）...此局限性未确定 |  |  |
| pikpak 服务需要魔法访问 |  | 升级设备，本机做服务器，10T 空间替代 pikpak 服务 |
